...
img.resize((w_cover, h_cover)).save(f"img/{cover_img[:-4]}-with-WM-{logo_img[:-4]}-resize.jpg")
...
img3.resize((w_logo, h_logo)).save(f"img/from-{cover_img[:-4]}-extract-WM-{logo_img[:-4]}-resize.jpg")
